...
// Depth 104
typedef void(*Fn__RayColor_void)(RayColor);
...
// Depth 104
typedef RayColor(*Fn__uint8_t_uint8_t_uint8_t_uint8_t_RayColor)(uint8_t, uint8_t, uint8_t, uint8_t);
...
// Depth 505
typedef void(*Fn__CChar_MUL__int_int_int_RayColor_void)(CChar*, int, int, int, RayColor);
...
// Depth 505
typedef void(*Fn__int_int_CChar_MUL__void)(int, int, CChar*);
...
// Depth 500
Color Raylib_make_MINUS_color(uint8_t r, uint8_t g, uint8_t b, uint8_t a);
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        static String _6 = "KoiRTS";
        String *_6_ref = &_6;
        String _7 = String_copy(_6_ref);
        String title = _7;
        String* _17 = &title; // ref
        CChar* _18 = String_cstr(_17);
        InitWindow(1280, 720, _18);
        SetTargetFPS(60);
        bool _26 = WindowShouldClose();
        bool _27 = not(_26);
        bool _74 = _27;
        while (_74) {
            BeginDrawing();
            uint8_t _35 = Byte_from_MINUS_int(245);
            uint8_t _38 = Byte_from_MINUS_int(245);
            uint8_t _41 = Byte_from_MINUS_int(245);
            uint8_t _44 = Byte_from_MINUS_int(255);
            RayColor _45 = Raylib_make_MINUS_color(_35, _38, _41, _44);
            ClearBackground(_45);
            String* _51 = &title; // ref
            CChar* _52 = String_cstr(_51);
            uint8_t _59 = Byte_from_MINUS_int(25);
            uint8_t _62 = Byte_from_MINUS_int(25);
            uint8_t _65 = Byte_from_MINUS_int(25);
            uint8_t _68 = Byte_from_MINUS_int(255);
            RayColor _69 = Raylib_make_MINUS_color(_59, _62, _65, _68);
            DrawText(_52, 20, 20, 28, _69);
            EndDrawing();
            bool _26 = WindowShouldClose();
            bool _27 = not(_26);
            _74 = _27;
